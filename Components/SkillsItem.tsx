...
const SkillsItem = ({title,year}: Props) => {
    return (
        <div className='mb-[4rem] md:mb-[8rem]'>
            ...
            <p className='text-[#aaaaaa] font-normal w-[80%] text-[17px] opacity-80'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero expedita eum, aut praesentium ut reiciendis blanditiis soluta doloribus delectus ad.</p>
        </div>
    );
};
